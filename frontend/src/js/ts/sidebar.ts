...
import { AddScript, setuppage, sleep, UpdateMain } from "./utils.js";
...
async function OpenDropdown() {
    ...
    let contentwidth = <number>$(".content").outerWidth();
    let _90percent = contentwidth * 0.9;
    let marginwidth = <number>$(".content").outerWidth(true) - contentwidth;
    ...
    let finalmargin =
        <number>$(".content").outerWidth(true) -
        <number>$(".content").outerWidth();
...
function CloseDropdown(ogwidth: number, ogmargin: number, ogsidebar: number) {
